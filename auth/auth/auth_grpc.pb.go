...
func (c *authServiceClient) Register(ctx context.Context, in *RegistrationRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
func (UnimplementedAuthServiceServer) Register(context.Context, *RegistrationRequest) (*AuthResponse, error) {
